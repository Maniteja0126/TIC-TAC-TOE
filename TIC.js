...
//checking if player x won or not after disabled all other fields
...
// Checking of Player X finish
    ...
    else if((b3=='0' || b3=='0') && (b6=='0'||b6=='0') && (b9=='0x'||b9=='0')){
        document.getElementById('print').innerHTML="Player 0 won";
        document.getElementById('print').style.color='red';
        document.getElementById(b1).disabled=true;
        document.getElementById(b2).disabled=true;
    ...
    //Checking Player 0 finish
    //here ,checking about tile
    // else if((b1=='X'||b1=='0') &&(b=='X'||b2=='0')&&(b3=='X'||b3=='0')&&(b4=='X'||b4=='0')&&(b5=='X'||b5=='0')&&(b6=='X'||b6=='0')&&(b7=='X'||b7=='0')&&(b8=='X'||b8=='0')&&(b9=='X'||b9=='0')){
...
//Here onwards , function check turn of the player
